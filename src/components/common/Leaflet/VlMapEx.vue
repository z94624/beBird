<template>
	<div class="fullContainer relative">
		...
		<div
			...
			class="pointer-events-none absolute left-1/2 top-6 z-[401] -translate-x-1/2"
		>
			<q-chip
				:icon="isMobile ? 'mdiGestureTapHold' : 'mdiMouseRightClickOutline'"
				class="shadow-2 opacity-80"
				color="dark"
				size="sm"
				text-color="white"
			>
				{{ isMobile ? $t('geocoding.hint.longPress') : $t('geocoding.hint.rightClick') }}
			</q-chip>
		</div>
