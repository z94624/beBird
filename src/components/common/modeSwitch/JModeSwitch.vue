			...
			>
				<span class="pilot-bear">
					...
					>
						...
						/>
						<path
							d="M59.871 212.892H95.35v656.367H59.871z"
							fill="#000"
						/>
						<path
							d="M106.438 523.336v35.479H59.871v-35.479z"
							fill="#000"
						/>
						<path
...
<style lang="scss" scoped>
	...
	.toggle {
		...
		box-shadow:
			calc(v-bind(width) * 0) calc(v-bind(width) * 0.02) calc(v-bind(width) * 0.01)
				calc(v-bind(width) * -0.0025) hsl(210 10% 100% / 0.95),
			calc(v-bind(width) * 0) calc(v-bind(width) * -0.02) calc(v-bind(width) * 0.01)
				calc(v-bind(width) * -0.0025) hsl(210 10% 10% / 0.2),
			calc(v-bind(width) * 0) calc(v-bind(width) * 0.02) calc(v-bind(width) * 0.5) 0
				hsl(210 10% 100% / 0.15);
	}
	...
	.toggle:after {
		...
		inset: 0;
		box-shadow:
			calc(v-bind(width) * 0) calc(v-bind(width) * -0.025) calc(v-bind(width) * 0.025) 0
	...
	.moon__crater {
		...
		top: calc(var(--y) * 1%);
		box-shadow:
			calc(v-bind(width) * 0.01) calc(v-bind(width) * 0.01) calc(v-bind(width) * 0.01) 0
				hsl(210 10% 6% / 0.25) inset,
			0 calc(v-bind(width) * 0.005) calc(v-bind(width) * 0.01) 0 hsl(210 10% 100% / 0.25);
	}
	...
	[type='checkbox'] {
		accent-color: $color;
		transition: accent-color $speed $easing;
	}
